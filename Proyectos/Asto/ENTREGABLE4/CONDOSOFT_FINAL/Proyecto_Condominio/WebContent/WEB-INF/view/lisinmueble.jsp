...
<section class="header6 cid-qyUzfpWTSb mbr-fullscreen"
	...
	<div class="container">
		...
		<H3 style="color: white">
			<P ALIGN=center>REGISTRO DE INMUEBLE</P>
		</H3>
		<br> <br>
 ...
 <div class="row justify-content-md-center">
  ...
  <tr>
        <td colspan="2" style="background-color: #d2795c; height:40; border: white 10px solid;"><b style="color: white"><center>NUEVO INMUEBLES</center></b></td>
   ...
   <td width="50px">
     ...
     <table style="border: white 10px solid; width:100%;">
       ...
       <tr>
        ...
        <td style="background-color: #d2795c; height:50; border: white 10px solid;"><b style="color: white">TIPO</b></td>
                <td style="background-color: #d2795c; height:50; border: white 10px solid;"><b style="color: white">PISO</b></td>
                <td style="background-color: #d2795c; height:50; border: white 10px solid;"><b style="color: white">TORRE</b></td>
