        ...
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i> <strong>GESTIO DE GASTOS</strong> </h2>
...
<td class="center">${user.fecha}</td>
 ...
 <td> 
                                <a class="btn btn-danger"  href="UserController4?action=delete&userId=<c:out value="${user.idgasto}"/>">
