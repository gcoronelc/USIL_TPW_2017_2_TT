			...
			<div class="col-md-6">
				...
				<div class="login-mail">
				   ...
				   <a class="news-letter " href="#">
						 <label class="checkbox1"><input type="checkbox" name="checkbox" ><i> </i>Recordar Contraseña</label>
					   </a>
...
<div class="copy-right">
            <p> &copy; 2017 CondoSoft. Todos los derechos reservados | Diseño de CondoSoft </div>  
<!---->
<!--scrolling js-->
