...
<center>
  <h1 style="color: white">OBLIGACION DE MANTENIMIENTO</h1>
 ...
 <H3 style="color: white"><P ALIGN=RIGHT>LISTA.</P></H3>
  ...
  <tr>
      ...
      <tr> 
    <td style="background-color: #7f8c8d;border: white 10px solid;"><b><label style="color: white">Seleccione Inmueble:</label></b></td>
    <td style="background-color: #ecf0f1;border: white 10px solid;"><b><select><option>Departamentos<option>Oficinas<option>Cocheras</select></b></td>
    </tr>
    <tr> 
      ...
      <tr>
        ...
        <td style="background-color: rgb(189, 195, 199); height:40; border: white 10px solid;"><b>DEPAR002</b></td>
                <td style="background-color: rgb(189, 195, 199); height:40; border: white 10px solid;"><b>40.5</b></td>
                                <td style="background-color: rgb(189, 195, 199); height:40; border: white 10px solid;"><b>25-08-17</b></td>
        ...
        <td style="background-color: #3CA294; height:40; border: white 10px solid;"><b><a href="obagua.htm?idpro=c001"style="color: white">PAGAR</b></a></td>
           ...
           <tr>
        <td style="background-color: rgb(189, 195, 199); height:40; border: white 10px solid;"><b>P002</b></td>
        <td style="background-color: rgb(189, 195, 199); height:40; border: white 10px solid;"><b>OFIC002</b></td>
                <td style="background-color: rgb(189, 195, 199); height:40; border: white 10px solid;"><b>35.5</b></td>
                                <td style="background-color: rgb(189, 195, 199); height:40; border: white 10px solid;"><b>25-08-17</b></td>
                                                <td style="background-color: #E39641; height:40; border: white 10px solid;"><b style="color: white">Pendiente</b></td>
