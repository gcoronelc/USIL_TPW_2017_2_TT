...
public class AppController {
  ...
  @RequestMapping(value="mejor.htm", method=RequestMethod.GET)
  public String mejor(){
	  return "mejor";
  }
  
  @RequestMapping(value="mejor.htm", method=RequestMethod.POST)
  public String mejor(
    ...
    List<Map<String, Object>> lista;
    lista = reporteService.repoMejorCurso(periodo);
    model.addAttribute("lista", lista);
